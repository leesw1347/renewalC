...
MyString05::MyString05(const char *n) {
    std::cout << "MyString05 클래스 생성자 호출 " << n << std::endl;
}

MyString05::MyString05(const MyString05 &other) {
    std::cout << "MyString05 클래스 복사 생성자 호출" << std::endl;
}
...
MyString05::~MyString05() {
    std::cout << "MyString05 클래스 소멸자 호츨" << std::endl;
}

MyString05 &MyString05::operator=(const MyString05 &other) {
    std::cout << "MyString05 클래스 이동 연산자 호출" << std::endl;
}
